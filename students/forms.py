...
from utils.constant import (
    ...
    STUDENT_USERNAME_MAX_LENGTH, STUDENT_INVALID_CREDENTIALS_ERROR, STUDENT_IS_STUDENT_ATTRIBUTE,
...
class StudentLoginForm(forms.Form):
    """
    Form for student authentication
    """
    username = forms.CharField(
        max_length=STUDENT_USERNAME_MAX_LENGTH,
    ...
    def clean(self):
        """
        Validate user credentials and check if user is a student
        """
        ...
        if username and password:
            ...
            if not getattr(self.user_cache, STUDENT_IS_STUDENT_ATTRIBUTE, False):
                raise ValidationError(_(STUDENT_INVALID_CREDENTIALS_ERROR))
