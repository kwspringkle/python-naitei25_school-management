...
urlpatterns = [
    ...
    path('<int:assign_id>/view_students/',
         views.view_students, name='view_students'),
    path('<int:assign_id>/marks_list/',
         views.t_marks_list, name='t_marks_list'),
    path('<int:assign_id>/enter_marks/',
         views.t_marks_list, name='enter_marks'),
    ...
    path('<int:assign_id>/Report/', views.t_report, name='t_report'),
]
